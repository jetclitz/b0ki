...
<div class="art-box art-vmenublock">
	...
	<li>
		...
		<ul class="active">
			<li>
                <a href="../../new-page/borrow.html" class="active">Borrow</a>
		<ul class="active">
			<li>
                <a href="../../new-page/borrow/book.php">Book</a>

            </li>
			<li>
                <a href="../../new-page/borrow/magazine.php" class="active">Magazine</a>
...
?>
	...
	<tr><td width="87">Name of Borrower:</td>
	<td width="551"><div align="left">
	<input type="text" value="<?=$_GET['name'];?>" name="name" />
	</div></td></tr>
	<tr><td colspan="2" align="center"><a href="javascript:history.go(-1);">Return to UI</a> |<input name="Submit" type="submit" value="Borrow" /></td></tr>
...
<?php 
	...
	$sql = "UPDATE mag SET name = '" . $name ."', publisher = '" . $author . "', status='Borrowed' WHERE id = '" . $id . "'";
	mysql_query($sql);
	...
	$sql ="SELECT * FROM mag WHERE status='Available' ORDER BY magname ASC";
	$data = mysql_query($sql);

?>
<h2>Borrow Magazines</h2>
<table class="tableStyleClass">
<tr>
<th width="100">Name of the Magazine</th>
<th width="200">Name of the Publisher</th>
<th width="100" colspan="1">Status</th>
<th width="100" colspan="1">Admin</th>
</tr>
<?php
...
<td><?=$info['status'];?></a></td>
<td><a href="<?=$_SERVER['PHP_SELF'];?>?id=<?=$info['id'];?>&title=<?=$info['magname'];?>&author=<?=$info['publisher'];?>&mode=edit" >Borrow </a></td>
</tr>
<?php
}
?>
