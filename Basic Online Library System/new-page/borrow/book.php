...
<div class="art-box art-vmenublock">
	...
	<li>
		...
		<ul class="active">
			<li>
                <a href="../../new-page/borrow/book.php" class="active">Book</a>

            </li>
			<li>
                <a href="../../new-page/borrow/magazine.php">Magazine</a>
...
<div class="art-post-inner art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Book Page
                                        </h2>
                                                        </div>
...
<?php 
	...
	$sql = "UPDATE lib SET name = '" . $name ."', author = '" . $author . "', status='Borrowed' WHERE id = '" . $id . "'";
	mysql_query($sql);
	...
	$sql ="SELECT * FROM lib WHERE status='Available' ORDER BY title ASC";
...
<td><?=$info['author'];?></a></td>
<td><?=$info['status'];?></a></td>
<td><a href="<?=$_SERVER['PHP_SELF'];?>?id=<?=$info['id'];?>&title=<?=$info['title'];?>&author=<?=$info['author'];?>&mode=edit" >Borrow </a></td>
</tr>
<?php
}
?>
