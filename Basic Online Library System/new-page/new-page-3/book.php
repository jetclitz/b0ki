...
<div class="art-box art-vmenublock">
	...
	<li>
		...
		<ul class="active">
			<li>
                <a href="../../new-page/new-page-3/book.php" class="active">Book</a>

            </li>
			<li>
                <a href="../../new-page/new-page-3/magazine.php">Magazine</a>
...
<?php 
	...
	$sql = "UPDATE lib SET name = 'NULL', author = '" . $author . "', status='Available' WHERE id = '" . $id . "'";
	mysql_query($sql);
	...
	$sql ="SELECT * FROM lib WHERE status='Borrowed' ORDER BY title ASC";
...
<td><?=$duedate;?></a></td>
<td><?=$info['status'];?></a></td>
<td><a href="<?=$_SERVER['PHP_SELF'];?>?id=<?=$info['id'];?>&title=<?=$info['title'];?>&author=<?=$info['author'];?>&mode=edit" >Make Available </a></td>
</tr>
<?php
}
?>
