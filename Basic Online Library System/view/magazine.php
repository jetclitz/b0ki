...
<div class="art-box art-vmenublock">
	...
	<li>
		...
		<ul class="active">
			...
			<li>
                <a href="../view/magazine.php" class="active">Magazine</a>

            </li>
			<li>
                <a href="../view/ebook.php">Ebook</a>
...
<div class="art-post-inner art-article">
                                <div class="art-postmetadataheader">
                                        <h2 class="art-postheader">Magazines
                                        </h2>
                                                        </div>
							...
							$title=mysql_result($request,$rows,'magname');
							$author=mysql_result($request,$rows,'publisher');
							$status=mysql_result($request,$rows,'status');
